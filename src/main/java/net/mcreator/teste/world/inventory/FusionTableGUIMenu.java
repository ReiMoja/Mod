...
package net.mcreator.teste.world.inventory;
...
public class FusionTableGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FusionTableGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 109, 44) {
			@Override
